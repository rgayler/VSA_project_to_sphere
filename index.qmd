...
If the hpervectors lie on a hypersphere it is convenient to project them to the surface of a sphere.
...
It doesn't matter that the visualisation space is real valued.
...
This is convenient because we can visualise a maximum of three mutually orthogonal vector on the surface of a sphere.
...
Then we visualise the action of the unary partial function rather than the binary operator.
